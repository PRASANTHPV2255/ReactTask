                ...
                <div>
                  <button type="button" class="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                    <div class="flex space-x-4"> 
                      <a href="#" class="bg-green-900 text-white rounded-md px-3 py-2 text-sm font-large" aria-current="page" onClick={register}>Register</a>
                    </div>
                  </button>
                </div>
              </div>
      ...
      <div className='login'>
        <div className='card-style'>
          <form className='pl-20' style={{width:'100%'}}>
            <div class="space-y-5">
              <div class="pb-10">
                <h1 class="text-3xl font-semibold leading-7  text-gray-900">Login</h1>
                <div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-6">
                  ...
                  <div class="sm:col-span-4">
                    ...
                    <div class="mt-2">
                      <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                        <input type="password" name="password" value={password} id="password" onChange={(e)=>setpassword(e.target.value)} autocomplete="password" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="Enter passsword"/>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="mt-3 flex items-center gap-x-25">
              <button type="submit" class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" onClick={handleSubmit}>Login</button>
            </div>
          </form>
        </div>
      </div>
